...
const EditJobPage = ({ updateJobSubmit }) => {
  ...
  // To navigate programmatically after form submission
  const navigate = useNavigate();
  // To recieve the job ID from the URL
  const { id } = useParams();
  ...
  const submitForm = (e) => {
    ...
    // To construct the updated job object
    const updatedJob = {
      id,
      title,
      type,
    ...
    // To navigate to the updated job's page
    ...
    <section className='bg-indigo-50'>
      <div className='container m-auto max-w-2xl py-24'>
        <div className='bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0'>
          ...
          {/* To edit the form which contains various input fields for job details such as title, type, location, description, salary, and company information. */}
